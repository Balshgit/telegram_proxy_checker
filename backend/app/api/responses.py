...
from app.api.base_schemas import BaseResponse, GenericResponse
...
def build_responses(
    *,
    status_code: int,
    response_model: type[BaseResponse | GenericResponse] | None,
    ...
    responses: dict[Any, Any] = {status_code: {"model": response_model}}
